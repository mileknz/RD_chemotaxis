...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%first row: load the pattern measurements for inside Turing space
...
subplot(2,3,1)
load('Fig6_Mu_fit_abc_Dw40fvpos.mat')
...
subplot(2,3,2)
load('Fig6_Mv_fit_abc_Dw40fvpos.mat')
...
subplot(2,3,3)
load('Fig6_Mw_fit_abc_Dw40fvpos.mat')
...
% plot u with e2=0
subplot(2,3,4)
load('Fig6_Mu_fit_def_Dw1fvneg.mat')
...
% legend({'\epsilon_{1}=1, \epsilon_{2}=1','\epsilon_{1}=0, \epsilon_{2}=1','\epsilon_{1}=1, \epsilon_{2}=0',...
%     '\epsilon_{1}=0, \epsilon_{2}=0'},'Position',...
% [0.222899845668248 0.132603264016265 0.0988095238095236 0.263923754977893])
...
subplot(2,3,5)
load('Fig6_Mv_fit_def_Dw1fvneg.mat')
...
subplot(2,3,6)
load('Fig6_Mw_fit_def_Dw1fvneg.mat')
...
%           save eps file
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% saveas(gcf,'measurement_chi_1','epsc')
