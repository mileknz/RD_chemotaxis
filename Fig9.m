...
%%%%%%%%%%%%%%%%%%%%%%%
%   PARAMETERS PLOT Fig9.a
a1=0.2; 
c1=1.3; 
Dw1=40;

M1 = Fig9_ab(du,a1,c1,e1,ve2,gamma,Dw1,vchi,e3);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%%%%%%%%%%%%%%%%%%%%%%%
%   PARAMETERS PLOT Fig9.b
a2=1; 
c2=0.5; 
Dw2=1;

M2 = Fig9_ab(du,a2,c2,e1,ve2,gamma,Dw2,vchi,e3);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%
%   PARAMETERS PLOT Fig9.c
a3=0.2; 
c3=0.2; 
Dw3=1;
...
M3 = Fig9_c(du,a3,c3,e1,e2,gamma,Dw3,vchi,ve3);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
